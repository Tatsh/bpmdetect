 ...
 */
void Track::saveBPM( string filename, double dBPM, string format ) {
  FMOD_SOUND *sound;
  FMOD_RESULT result;
...
taginfo_t Track::getTagInfoMPEG(string filename) {
  taginfo_t tagnfo;
 ...
 */
taginfo_t Track::getTagInfoWAV(string filename) {
  taginfo_t tagnfo;
 ...
 */
double Track::correctBPM( double dBPM, double min, double max ) {
 ...
 */
void Track::printBPM( double dBPM, string format ) {
 ...
 * @return detected BPM
 */
double Track::detectBPM( string filename ) {
  FMOD_SOUND * sound;
  FMOD_RESULT result;
  FMOD_TAG tag;
